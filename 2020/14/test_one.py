...
def test_parse_mask():
    assert one.parse_mask('mask = XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX') == (0,2**36-1)
    assert one.parse_mask('mask = 111111111111111111111111111111111111') == (0b111111111111111111111111111111111111,2**36-1)
